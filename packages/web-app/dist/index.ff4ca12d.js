...
})({"1ycnO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c6b782cbff4ca12d";
"use strict";
...
},{}],"bD46w":[function(require,module,exports) {
var _uiLibrary = require("@my-monorepo/ui-library");
var _init = require("snabbdom/build/init");
var _h = require("snabbdom/build/h");
const patch = (0, _init.init)([]);
const [state, updateState] = (0, _uiLibrary.createReactivity)();
const mount = (0, _uiLibrary.createLifecycle)(()=>console.log("Component mounted"));
// interface State {
//   count: number;
// }
const template = (0, _uiLibrary.createTemplate)((state = {
    count: 0
})=>{
    return (0, _h.h)("div", [
        (0, _h.h)("h1", state.count),
        (0, _h.h)("button", {
            on: {
                click: ()=>updateState({
                        count: state.count + 1
...
let oldVNode = null; // Initialize with null
...
const render = ()=>{
    ...
    if (!oldVNode) {
        if (appElement) oldVNode = patch(appElement, newVNode);
        else // Handle the case where appElement is null
        console.error("appElement is null");
    } else patch(oldVNode, newVNode);
...
},{"@my-monorepo/ui-library":"9AQGw","snabbdom/build/init":"d6X9p","snabbdom/build/h":"bCpOB"}],"9AQGw":[function(require,module,exports) {
"use strict";
...
__exportStar(require("c509babd04a4c42"), exports);
__exportStar(require("28beef797b1a55f9"), exports);
__exportStar(require("a22fbfd363af1fa5"), exports);

},{"c509babd04a4c42":"dOXAN","28beef797b1a55f9":"hj9pH","a22fbfd363af1fa5":"8f2pu"}],"dOXAN":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"hj9pH":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"8f2pu":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.createLifecycle = void 0;
const createLifecycle = (mount)=>mount;
...
},{"./vnode":"fNqAR","./is":"kHAzx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1ycnO","bD46w"], "bD46w", "parcelRequire6577")

//# sourceMappingURL=index.ff4ca12d.js.map
